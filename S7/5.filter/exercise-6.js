...
function viciados(unArray) {
    let viciadosDelLol = unArray.gameMorePlayed.includes('Legends')
    unArray.age > 35 ? unArray.gameMorePlayed = unArray.gameMorePlayed.toUpperCase() : ""
    return viciadosDelLol
}
console.log(streamers.filter(viciados));